...
class RedisClientStringsTest extends TestCase
{
    ...
    public function testSetBit()
    {
        ...
        $result = $this->client->setBit($key, $offset, $value);
    ...
    public function testSetRange()
    {
        ...
        $result = $this->client->setRange($key, $offset, $value);
